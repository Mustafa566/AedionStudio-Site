...
<body>
    ...
    <div class="gap"></div>
        ...
        <div class="row wrap w100">
            <div class="inputDiv grow" v-for="page in contactPage.inputFieldNames">
                <input type="text" :placeholder="page.name" class="contactFormInput bgWhite outline" v-model="page.data" required>
            </div>
        </div>
    ...
    <div class="gap"></div>
            ...
            <div class="row wrap w100">
                <div class="pdfDiv bgWhite">
                    <input type="text" placeholder="PDF Explaination..." class="pdfInput bgWhite outline" v-model="contactPage.pdfExplain" required>
                </div>
